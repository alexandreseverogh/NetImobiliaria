...
BEGIN
    ...
    -- [1] HARD BYPASS: Se for o usu??rio admin original, n??vel ?? 6
    ...
    -- [4] Sele????o de Itens (Proje????o Limpa para o Frontend)
        ...
        WHERE s.is_active = true
          ...
          AND (
            ...
            OR (
                ...
                -- Verifica????o de Blueprint (se n??o houver override)
