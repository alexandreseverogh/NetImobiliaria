-- [GOVERNANÇA SIDEBAR V6] - Correção de Coluna Inexistente em Overrides
-- Remove referência a user_id na tabela tenant_feature_overrides que não possui esta coluna
    ...
    WITH allowed_items AS (
        ...
        WHERE s.is_active = true
          ...
          AND (
            ...
            OR EXISTS (
                -- Overrides (Ajustado: removido user_id que não existe na tabela)
