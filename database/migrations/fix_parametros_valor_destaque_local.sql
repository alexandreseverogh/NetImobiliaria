-- Script de Correção: Remove tabelas antigas (se existirem) e cria novamente com nomes corretos
-- Execute este script se as tabelas não aparecerem no pgAdmin
...
-- Remover trigger e função da tabela antiga (se existir)
...
-- =====================================================
-- PASSO 2: CRIAR TABELAS COM NOMES CORRETOS
-- =====================================================
...
-- Verificar dados
SELECT 'Total registros em parametros:', COUNT(*) FROM parametros;
SELECT 'Total registros em valor_destaque_local:', COUNT(*) FROM valor_destaque_local;
