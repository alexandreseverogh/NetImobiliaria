-- LIMPEZA DE VERSÕES OBSOLETAS
DROP FUNCTION IF EXISTS public.get_sidebar_menu_for_user(uuid, text, uuid);
DROP FUNCTION IF EXISTS public.get_sidebar_menu_for_user(uuid, uuid);

-- NOVA FUNÇÃO V3.6.1 (HARMONIZADA)
...
DECLARE
    ...
    v_menu JSONB;
BEGIN
    -- 1. Obter nível de acesso (Membership > Global)
    ...
    -- 2. Gerar Menu Relacional (V3.6.1)
