-- Migration SEM TRANSAÇÃO: Criar tabelas Parametros e Valor_Destaque_Local
-- IMPORTANTE: Execute este script com AUTOCOMMIT ATIVADO no pgAdmin
-- Ou execute cada comando individualmente

-- =====================================================
-- INSTRUÇÃO: No pgAdmin, vá em File > Preferences > Query Tool > 
--            Desmarque "Auto-rollback on error" e marque "Auto-commit"
-- =====================================================

-- PASSO 1: Fechar qualquer transação pendente (execute primeiro)
-- Se der erro, ignore e continue

-- PASSO 2: Remover objetos antigos
...
-- PASSO 3: Criar tabela parametros
...
-- PASSO 4: Criar tabela valor_destaque_local
