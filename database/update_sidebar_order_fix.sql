-- UPGRADE FINAL: HIERARQUIA DE FERRO E ORDEM DE FABRICA (FIXED ORDER)
-- Versao com ordenacao final corrigida para respeitar o order_index
...
BEGIN
    ...
    FROM (
        ...
        -- ORDENACAO FINAL: Primeiro Pais (NULL parent_id), depois Filhos, respeitando o order_index
        ...
        FROM distinct_items
        ORDER BY 
            (parent_id IS NOT NULL), -- Pais primeiro (FALSE < TRUE)
