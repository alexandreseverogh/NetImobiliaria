-- 037_email_template_novo_lead_corretor_imovel_fk.sql
-- Template de email: notificar corretor quando um novo lead for direcionado diretamente via imoveis.corretor_fk.
-- IMPORTANTE: não deve pedir "aceite" e nem exibir botão "aceitar lead" (isso é exclusivo do transbordo/SLA).
