-- 038_update_email_template_novo_lead_corretor_blocks.sql
-- Atualiza template novo-lead-corretor para incluir 3 blocos:
-- 1) Imóvel (infos do step 1 e 2 do cadastro)
-- 2) Proprietário
-- 3) Cliente (Tenho interesse)
-- Mantém a mensagem de "aceite necessário" e o botão "Abrir painel e aceitar lead" (EXCLUSIVO do fluxo com SLA/transbordo).
