...
BEGIN
    -- [1] HARD BYPASS: Se for o usuário admin original
    ...
    -- [4] Seleção de Itens (Projeção Limpa)
    ...
    FROM (
        ...
        WHERE s.is_active = true
          ...
          -- [BYPASS MASTER] Se for Super Admin, vê tudo. 
          -- Para outros, filtra por módulos (Entitlements)
          AND (
            _v_is_superadm = true
          ...
          -- Filtro de Permissões (Super Admin vê tudo aqui também)
          AND (
            _v_is_superadm = true
