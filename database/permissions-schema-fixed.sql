-- =====================================================
-- SISTEMA DE PERMISSÕES - NET IMOBILIÁRIA (CORRIGIDO)
-- =====================================================
...
-- Tabela de associação usuário-perfil (CORRIGIDO para UUID)
...
-- Tabela de permissões por perfil (CORRIGIDO para UUID)
...
-- Tabela de logs de auditoria (CORRIGIDO para UUID)
