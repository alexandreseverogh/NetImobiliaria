...
# Verificar se ja existe processo do Next.js rodando
...
if ($nextProcesses) {
    Write-Host "[!] Servidor Next.js ja esta rodando!" -ForegroundColor Yellow
    Write-Host "   PIDs encontrados: $($nextProcesses.Id -join ', ')" -ForegroundColor Gray
    Write-Host ""
