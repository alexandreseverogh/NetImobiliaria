-- ESTRATÉGIA CORRIGIDA PARA OTIMIZAÇÃO DE CONSULTAS PÚBLICAS
...
-- =====================================================
-- 3. VIEW MATERIALIZADA PARA IMAGENS PRINCIPAIS (CORRIGIDA)
-- =====================================================
...
WHERE i.ativo = true
GROUP BY i.id, i.codigo, i.titulo, i.estado_fk, i.cidade_fk, i.finalidade_fk, i.status_fk, i.ativo, i.preco, i.quartos, i.area_total, i.bairro, img.id, img.nome_arquivo, img.tipo_mime, img.tamanho_bytes, img.ordem, img.principal;

-- =====================================================
-- 4. VIEW MATERIALIZADA PARA DOCUMENTOS (CORRIGIDA)
-- =====================================================
...
FROM imoveis i
LEFT JOIN documento_imovel d ON i.id = d.imovel_fk
...
SELECT 
    ...
    indexname
FROM pg_indexes 
WHERE tablename = 'imoveis' AND indexname LIKE 'idx_imoveis_%'
ORDER BY indexname;
