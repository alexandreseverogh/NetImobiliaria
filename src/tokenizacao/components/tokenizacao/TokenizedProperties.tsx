...
export default function TokenizedProperties() {
  ...
  const getStatusText = (token: TokenData) => {
    ...
    if (token.status === 'ACTIVE') return 'Tokenização Ativa'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Invista em imóveis premium através de tokens digitais
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            de especialistas em mercado imobiliário.
          </p>
        </div>
        ...
        {filteredTokens.length > 0 ? (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-600">Preço por Token</span>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between text-sm mb-2">
                      <span className="text-gray-600">Progresso da Tokenização</span>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-600">Tokens Disponíveis</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              {activeTab === 'all' ? 'Não há tokens disponíveis no momento.' :
               activeTab === 'active' ? 'Todos os tokens ativos estão esgotados.' :
               'Não há tokens programados para lançamento.'}
            </p>
            <button 
              onClick={fetchTokens}
              className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Nossa equipe está sempre trabalhando para trazer novos imóveis premium. 
              Cadastre-se para ser notificado sobre novos lançamentos.
            </p>
