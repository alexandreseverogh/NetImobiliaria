...
interface EditTipoDocumentoModalProps {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrors({ submit: errorData.error || 'Erro ao atualizar tipo de documento' })
      }
    } catch (error) {
      console.error('Erro ao atualizar tipo de documento:', error)
      setErrors({ submit: 'Erro ao atualizar tipo de documento. Tente novamente.' })
    } finally {
      setLoading(false)
    }
  }
