...
export default function ProprietariosPage() {
  ...
  const fetchProprietarios = useCallback(async (filtersToUse = filters) => {
    try {
      setLoading(true)
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const response = await fetch(`/api/admin/proprietarios/${id}`, {
        method: 'DELETE'
      })
              ...
              >
                ...
                <div className="bg-slate-700 rounded-lg p-3 -m-1 mb-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                      <button
                        onClick={() => router.push(`/admin/proprietarios/${proprietario.id}`)}
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-sm text-gray-900 text-right max-w-[200px] truncate">{proprietario.email}</span>
                  </div>
