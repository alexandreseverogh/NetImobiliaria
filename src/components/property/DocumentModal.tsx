          ...
          <div style={{
            ...
            <button
              onClick={() => {
                ...
                if (popup) {
                  // HTML/CSS fixo, sem nenhuma interpolação de dado externo — nome do arquivo
                  // e URL são atribuídos depois via propriedades do DOM (textContent/src),
                  // nunca via string HTML, pra nunca serem interpretados como markup/script.
                  popup.document.open()
