                ...
                {items.map((item: any) => (
                  ...
                  >
                    ...
                    <div className="text-right space-y-0.5 shrink-0">
                      ...
                      {item.observacoes && (
                        <p className="text-xs text-blue-600 italic leading-snug max-w-[220px]">
      ...
      <div className="space-y-4">
        {[1, 2].map((categoria) => (
          <div key={categoria}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-start justify-between p-2.5 bg-gray-100 rounded-lg gap-3">
