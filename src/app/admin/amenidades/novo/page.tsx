...
// Página de criação de nova amenidade
...
export default function NovaAmenidadePage() {
  ...
  const [formData, setFormData] = useState<NovaAmenidade>({
    nome: '',
    categoria: '',
    descricao: '',
    ativo: true
  ...
  const loadCategorias = useCallback(async () => {
    try {
      setLoading(true)
      console.log('🔍 Carregando categorias de amenidades...')
      const response = await get('/api/admin/categorias-amenidades')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await post('/api/admin/amenidades', formData)

      if (response.ok) {
        const result = await response.json()
        console.log('✅ Amenidade criada com sucesso:', result)
        alert('Amenidade criada com sucesso!')
      ...
      alert('Erro ao salvar amenidade')
    } finally {
      setSaving(false)
    }
  }
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Nova Amenidade</h1>
            <p className="mt-1 text-sm text-gray-500">
              Adicione uma nova amenidade ao sistema
            </p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Piscina adulta, Academia, Portaria 24h..."
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Descreva detalhes sobre esta amenidade..."
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
