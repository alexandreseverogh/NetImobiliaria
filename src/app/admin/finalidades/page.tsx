...
export default function FinalidadesPage() {
  ...
  const fetchFinalidades = useCallback(async (page = currentPage, term = searchTerm) => {
    try {
      setLoading(true)
      setError(null)
  ...
  }, [currentPage, searchTerm, get, itemsPerPage])
                  ...
                  <tr key={finalidade.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                        finalidade.tipo_destaque === 'DV' 
                          ? 'bg-purple-100 text-purple-800' 
                          : finalidade.tipo_destaque === 'DA'
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col gap-1">
                        {finalidade.alugar_landpaging && (
                          <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                            Aluguel
                          </span>
                        )}
                        {finalidade.vender_landpaging && (
                          <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">
                            Venda
                          </span>
                        )}
                        {!finalidade.alugar_landpaging && !finalidade.vender_landpaging && (
