...
export default function NovaCategoriaProximidadePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await post('/api/admin/categorias-proximidades', formData)
      ...
      router.replace('/admin/categorias-proximidades')
    } catch (err) {
