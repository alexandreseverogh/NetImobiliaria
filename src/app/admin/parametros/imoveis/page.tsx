...
export default function ParametrosPage() {
  ...
  const loadParametros = async () => {
    try {
      setLoading(true)
      const response = await get('/api/admin/parametros/imoveis')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await put('/api/admin/parametros/imoveis', finalData)
  ...
  return (
    <PermissionGuard resource="parametros_imoveis" action="EXECUTE">
