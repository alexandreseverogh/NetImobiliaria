...
import { ReadGuard, CreateGuard, UpdateGuard, DeleteGuard } from '@/components/admin/PermissionGuard'
...
export default function CategoriasAmenidadesPage() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const response = await del(`/api/admin/categorias-amenidades/${id}`)
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex space-x-3">
          ...
          <CreateGuard resource="categorias-amenidades">
            <Link
              href="/admin/categorias-amenidades/novo"
                    ...
                    <tr key={categoria.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end space-x-3">
                          <UpdateGuard resource="categorias-amenidades">
                            <Link
                              href={`/admin/categorias-amenidades/${categoria.id}/editar`}
                              className="text-blue-600 hover:text-blue-900"
                            >
                              <PencilIcon className="h-4 w-4" />
                            </Link>
                          </UpdateGuard>
                          <DeleteGuard resource="categorias-amenidades">
                            <button 
