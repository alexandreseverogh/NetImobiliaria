...
export default function EditarCategoriaAmenidadePage() {
  ...
  const fetchCategoria = useCallback(async () => {
    try {
      setLoading(true)
      const response = await get(`/api/admin/categorias-amenidades/${id}`)
      if (!response.ok) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await put(`/api/admin/categorias-amenidades/${id}`, formData)
      ...
      router.push('/admin/categorias-amenidades')
    } catch (err) {
