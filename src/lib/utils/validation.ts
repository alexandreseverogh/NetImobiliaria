...
export const validationSchemas = {
  ...
  user: {
    username: [
      ...
      { type: 'minLength', message: 'Nome de usuário deve ter pelo menos 3 caracteres', params: 3 },
      { type: 'maxLength', message: 'Nome de usuário deve ter no máximo 50 caracteres', params: 50 }
    ],
    email: [
  ...
  imovel: {
    titulo: [
      ...
      { type: 'maxLength', message: 'Título deve ter no máximo 200 caracteres', params: 200 }
    ],
    descricao: [
    ...
    vagasGaragem: [
      ...
      { type: 'range', message: 'Número de vagas de garagem deve estar entre 0 e 20', params: { min: 0, max: 20 } }
    ]
  },
  ...
  endereco: {
    endereco: [
      ...
      { type: 'minLength', message: 'Endereço deve ter pelo menos 3 caracteres', params: 3 },
      { type: 'maxLength', message: 'Endereço deve ter no máximo 200 caracteres', params: 200 }
    ],
    numero: [
      { type: 'required', message: 'Número é obrigatório' },
      { type: 'minLength', message: 'Número deve ter pelo menos 1 caractere', params: 1 },
      { type: 'maxLength', message: 'Número deve ter no máximo 20 caracteres', params: 20 }
    ],
    bairro: [
      { type: 'required', message: 'Bairro é obrigatório' },
      { type: 'minLength', message: 'Bairro deve ter pelo menos 2 caracteres', params: 2 },
      { type: 'maxLength', message: 'Bairro deve ter no máximo 100 caracteres', params: 100 }
    ],
    cidade: [
      { type: 'required', message: 'Cidade é obrigatória' },
      { type: 'minLength', message: 'Cidade deve ter pelo menos 2 caracteres', params: 2 },
      { type: 'maxLength', message: 'Cidade deve ter no máximo 100 caracteres', params: 100 }
    ],
    estado: [
      { type: 'required', message: 'Estado é obrigatório' },
      { type: 'minLength', message: 'Estado deve ter pelo menos 2 caracteres', params: 2 },
      { type: 'maxLength', message: 'Estado deve ter no máximo 2 caracteres', params: 2 }
    ],
    cep: [
      { type: 'required', message: 'CEP é obrigatório' },
      { type: 'minLength', message: 'CEP deve ter pelo menos 8 caracteres', params: 8 },
      { type: 'maxLength', message: 'CEP deve ter no máximo 9 caracteres', params: 9 }
    ]
  },
  ...
  categoria: {
    ...
    descricao: [
      { type: 'maxLength', message: 'Descrição deve ter no máximo 500 caracteres', params: 500 }
    ]
  }
}
